...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ asset('admin-site/template') }}/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ route(ADMIN_INDEX, ['all' => 'dashboard']) }}"><b>Admin</b>LTE</a>
    </div><!-- /.login-logo -->
...
<!-- iCheck -->
<script src="{{ asset('admin-site/template') }}/plugins/iCheck/icheck.min.js"></script>
<script>
    $(function () {
        $('input').iCheck({
